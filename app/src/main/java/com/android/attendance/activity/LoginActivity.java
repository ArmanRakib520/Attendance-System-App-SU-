            ...
            public void onClick(View v) {
                ...
                if (userrole.equals("Admin")) {
                    ...
                    if (TextUtils.isEmpty(user_name)) {
                        ...
                        if (user_name.equals("admin") & pass_word.equals("123123")) {
                    ...
                    TeacherBean teacherBean = dbAdapter.validateFaculty(user_name, pass_word);

                    if (teacherBean != null) {
                        Intent intent = new Intent(LoginActivity.this, AddAttandanceSessionActivity.class);
                        startActivity(intent);
                        finish();
                        ((ApplicationContext) LoginActivity.this.getApplicationContext()).setTeacherBean(teacherBean);
                        Toast.makeText(getApplicationContext(), "Login successful", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(getApplicationContext(), "Login failed", Toast.LENGTH_SHORT).show();
                    }
